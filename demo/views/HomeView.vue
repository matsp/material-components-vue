<template>
  <m-layout-grid-inner>
    <m-fab mini absolute-right icon="favorite" @click="openDialog" />
    ...
    <m-layout-grid-cell :span="6">
      ...
      <m-slider discrete display-markers v-model="sliderValue" :min="0" :max="50" />
    ...
    <m-layout-grid-cell>
      <m-grid-list start-icon twoline-caption>
