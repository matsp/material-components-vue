<template>
    <div class="drawer-frame-root">
        <m-drawer modal v-model="open">
            ...
            <m-drawer-content>
                <m-drawer-list>
                    ...
                    <m-list-item>
                        <m-icon icon="send" slot="graphic"/>
                        Sent Mail
                    </m-list-item>
                    <m-list-item>
                        <m-icon icon="drafts" slot="graphic"/>
                        Drafts
                    </m-list-item>
                    <m-list-group-divider/>
                    <m-list-group-subheader>Labels</m-list-group-subheader>
                    <m-list-item>
                        <m-icon icon="bookmark" slot="graphic"/>
                        Family
                    </m-list-item>
                    <m-list-item>
                        <m-icon icon="bookmark" slot="graphic"/>
                    ...
                    <m-list-group-divider/>
                    <m-list-item>
                        <m-icon icon="settings" slot="graphic"/>
                        Settings
                    </m-list-item>
                    <m-list-item>
        ...
        <div class="drawer-frame-app-content">
            <m-top-app-bar @nav="open = !open" class="drawer-top-app-bar" scrollTarget="scrollTarget"
                           title="Modal Drawer">
                <m-icon icon="menu" slot="navigation"/>
            </m-top-app-bar>
            <div class="drawer-main-content" id="scrollTarget">
